# Available .BIZ One-Word Domains (9,798)
...
> The full live catalog for this exact search currently contains **9,798 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,798 domains · **Median ask:** $118.19 · **High-demand under $2,500:** 2
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,798 live domains                         |
...
> Unique Domains. *Available .BIZ One-Word Domains*. Version 2026-08-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
