# Available .BIZ One-Word Domains (8,907)
...
> The full live catalog for this exact search currently contains **8,907 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 8,907 domains · **Median ask:** $205.02 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 8,907 live domains                         |
...
> Unique Domains. *Available .BIZ One-Word Domains*. Version 2026-05-08. Public GitHub extract for the exact Unique Domains search represented by this repository.
